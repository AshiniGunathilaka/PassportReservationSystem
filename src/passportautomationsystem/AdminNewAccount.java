 ...
 * @author ashin
 */
public class AdminNewAccount extends javax.swing.JFrame {

    /**
     * Creates new form AdminNewAccount
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Create New Account For Admins");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(c1, javax.swing.GroupLayout.PREFERRED_SIZE, 536, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(37, 37, 37)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String userId = c1.getText();
       
       String username = c2.getText();
       String surname = c3.getText();
       ...
       //popup massage to fill all field    
        JOptionPane.showConfirmDialog(this, "Plese enter all fields !","Try again", JOptionPane.ERROR_MESSAGE);
           ...
           int userIdInt = Integer.parseInt(userId);
            ob.adminInfo(userIdInt,username,surname,email);
       ...
       if (userId.isEmpty()||username.isEmpty()||username.isEmpty()||password.isEmpty()||email.isEmpty()){
       //popup massage to fill all field    
        JOptionPane.showConfirmDialog(this, "Plese enter all fields !","Try again", JOptionPane.ERROR_MESSAGE);
         }//if all fields fill can move to the basic information form
        else{
           int userIdInt = Integer.parseInt(userId);
            ob.adminInfo(userIdInt,password,username,email);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminNewAccount.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminNewAccount().setVisible(true);
            }
        });
    }
